            ...
            <div class="card">
              ...
              <div class="card-body">
                <div class="tab-content">
                  <form class="form-horizontal" action="../setting/function/updateuser.php" method="post" >
                      <div class="form-group">
                        <label for="inputName" class="col-sm-2 control-label">Username</label>
                        <div class="col-sm-10">
                          <input type="text"  name="username" value="<?php echo $ar['username'] ?>" class="form-control" id="inputName" placeholder="Name">
                        </div>
                        <input type="hidden" name="name" value="<?php echo $ar['username']?>">
                      </div>
                      <div class="form-group">
